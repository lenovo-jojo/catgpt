...
{
    /// <summary>
    /// Loads and manages VRM character models
    /// NOTE: This is legacy code. For new projects, use VRMModelManager instead.
    /// Kept for backward compatibility with existing scenes.
    /// </summary>
    [System.Obsolete("Use VRMModelManager for better model management features")]
